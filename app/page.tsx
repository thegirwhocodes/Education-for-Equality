        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-white/60 rounded-full px-4 py-1.5 text-sm mb-6">
              <span className="text-[var(--primary-dark)] font-medium">Foundational Literacy & Numeracy</span>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="mailto:info@educationforequality.org" className="btn-secondary text-center">
                Partner With Us
              </a>
            </div>
          </div>
